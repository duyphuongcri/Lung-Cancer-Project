...
class UNet_atten_Trinh(nn.Module):
    def __init__(self, normalize="batchnorm",img_ch=1,output_ch=1,ratio=16):
        ...
        self.Att6 = Attention_block(F_g=256,F_l=256)
        self.Cha6 = Channel_block(F_g=256,F_l=256,ratio=ratio)
        ...
        self.Att5 = Attention_block(F_g=128,F_l=128)
        self.Cha5= Channel_block(F_g=128,F_l=128,ratio=ratio)
        ...
        self.Att4 = Attention_block(F_g=64,F_l=64)
        self.Cha4= Channel_block(F_g=64,F_l=64,ratio=ratio)
        self.Up_conv4 = conv_block(ch_in=128, ch_out=64, normalize=normalize)
        
        self.Up3 = up_conv(ch_in=64,ch_out=32, normalize=normalize)
        self.Att3 = Attention_block(F_g=32,F_l=32)
        self.Cha3= Channel_block(F_g=32,F_l=32,ratio=ratio)
        self.Up_conv3 = conv_block(ch_in=64, ch_out=32, normalize=normalize)
        
        self.Up2 = up_conv(ch_in=32,ch_out=16, normalize=normalize)
        self.Att2 = Attention_block(F_g=16,F_l=16)
        self.Cha2= Channel_block(F_g=16,F_l=16,ratio=ratio)
    ...
    def forward(self,x):
        ...
        d6 = self.Up6(d7) #x6
        a5 = self.Att6(g=d6,x=x5)
        c5 = self.Cha6(g=d6,x=x5)
        x5 = (x5*a5) * c5
